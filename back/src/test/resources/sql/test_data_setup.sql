...
VALUES (9001, 1, 'TEST_Java풀스택', '2026-01-05', '2026-06-30', 'Y'),
       (9002, 1, 'TEST_Python데이터분석', '2026-03-02', '2026-08-31', 'Y'),
       (9003, 2, 'TEST_Java백엔드', '2026-01-06', '2026-06-27', 'Y');
...
SELECT 1, u.seq_user, 9001, 9001, '2026-05-01', '2026-05-10', 'Y' FROM tb_user u WHERE u.id_user = 'test_user01'
UNION ALL
SELECT 1, u.seq_user, 9001, 9002, '2026-05-20', NULL, 'Y' FROM tb_user u WHERE u.id_user = 'test_user01'
UNION ALL
SELECT 1, u.seq_user, 9001, 9001, '2026-05-05', '2026-05-15', 'Y' FROM tb_user u WHERE u.id_user = 'test_user02'
UNION ALL
SELECT 1, u.seq_user, 9002, 9003, '2026-05-10', NULL, 'Y' FROM tb_user u WHERE u.id_user = 'test_user03'
UNION ALL
SELECT 2, u.seq_user, 9003, 9004, '2026-04-01', NULL, 'Y' FROM tb_user u WHERE u.id_user = 'test_user04';
