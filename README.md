## 캠퍼스 라운지 도서 관리 시스템 (PlayBook)

---

### 한줄 요약 (Problem → Solution → Impact)
...
### 내 역할과 기여
- 백엔드 전반 설계/구현: `controller/service/repository` 계층, JPA 엔터티/DTO, 스케줄러, JWT 인증 유틸
- 프론트엔드 주요 화면 개발: 대여/반납, 검색, 통계(Chart.js)
- 인프라 구성: Docker Compose, MySQL 초기 스크립트, 실행 자동화
- 문서화: 요구사항 정의, ERD/아키텍처 정리, 빠른 시작 가이드
